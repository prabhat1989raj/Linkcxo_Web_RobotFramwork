...
${JOBS_FROM_SOCIAL_POSTS_TAB}    xpath=//button[normalize-space()='Jobs from Social Posts']
...
${EXTERNAL_APPLY_BUTTON}    xpath=//button[normalize-space()='Apply' or contains(normalize-space(),'External Apply')]
...
${FIRST_SOCIAL_POST_JOB_CARD}    xpath=(//div[@role='button' and @tabindex='0'][.//button[contains(translate(normalize-space(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'view post')]])[1]
...
Open All Jobs My Jobs And Social Posts
    ...
    Wait Until Element Is Visible    ${JOBS_FROM_SOCIAL_POSTS_TAB}    ${TIMEOUT}
    Click Element                    ${JOBS_FROM_SOCIAL_POSTS_TAB}
    Click First Social Post Job Card

Open Jobs From Social Posts Section
    Wait Until Element Is Visible    ${JOBS_TAB}    ${TIMEOUT}
    Click Element                    ${JOBS_TAB}
    Wait Until Element Is Visible    ${ALL_JOBS_TAB}    ${TIMEOUT}
    Click Element                    ${ALL_JOBS_TAB}
...
Click First Social Post Job Card
    Wait Until Element Is Visible    ${FIRST_SOCIAL_POST_JOB_CARD}    ${TIMEOUT}
    Scroll Element Into View         ${FIRST_SOCIAL_POST_JOB_CARD}
    Click Element                    ${FIRST_SOCIAL_POST_JOB_CARD}
    Wait Until Element Is Visible    ${BOOKMARK_BUTTON}    ${TIMEOUT}
